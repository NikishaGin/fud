...
export const Stage = {
    DRAFT: 'DRAFT',
    PENDING_BY_CURATOR_MIUDOL: 'PENDING_BY_CURATOR_MIUDOL',
    PENDING_BY_CURATOR_CA: 'PENDING_BY_CURATOR_CA',
...
export const STAGE_LABEL = {
    ...
    [Stage.PENDING_BY_CURATOR_MIUDOL]: 'На акцепте (ЗНИ)',
    [Stage.PENDING_BY_CURATOR_CA]: 'На акцепте (ЗНУ)',
...
const STAGE_TO_PROGRESS = {
    [Stage.DRAFT]: 5,
    [Stage.PENDING_BY_CURATOR_MIUDOL]: 25,
    [Stage.PENDING_BY_CURATOR_CA]: 25,
    [Stage.PENDING_BY_HEAD_INSPECTION]: 50,
    [Stage.PANDING_FINAL_MIUDOL]: 75,
    [Stage.PANDING_FINAL_CA]: 75,
    [Stage.APPROVED]: 100,
    [Stage.REJECTED]: 100,
};
...
const STAGE_TO_COLOR = {
    [Stage.DRAFT]: 'default',
    [Stage.PENDING_BY_CURATOR_MIUDOL]: 'secondary',
    [Stage.PENDING_BY_CURATOR_CA]: 'secondary',
